...
m = Matrix([[-8, 0, 15], [-16, 0, 15], [0, 56, -78], [15, 16, -17]])
new_m = Matrix([[-29, 67, 0], [-18, 0, 43], [0, 22, -23], [94, 12, -74]])
print(f'Исходная матрица 1:{m}')
print(f'Исходная матрица 2:{new_m}')
print(f'Сумма матриц:{m+new_m}')